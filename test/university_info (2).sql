...
--
-- Host: 127.0.0.1
-- Generation Time: 02 أبريل 2024 الساعة 10:11
...
(12324324, 'f', 'ffffff', 'mosacyber@gmail.com', '$2y$10$T4m.sXR9WjwyPHKZYFV8q.U02hqb6ObO03diRIzv/alfD7HOAii1e', 559718489, 1),
...
(421002998, '1', 233334, 452),
(421002998, '1', 233334, 461),
(421002998, '2', 233334, 451),
...
CREATE TABLE `grades` (
  `student_ID` int(9) NOT NULL,
  `coursework_id` int(10) NOT NULL,
  `coursework_Mark` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `grades`
  ADD PRIMARY KEY (`student_ID`,`coursework_id`),
  ADD KEY `student_ID` (`student_ID`,`coursework_id`),
...
--
ALTER TABLE `coursework`
  MODIFY `coursework_id` int(2) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `coursework_type`
--
ALTER TABLE `coursework_type`
  MODIFY `coursework_type_id` int(2) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `coursework`
  ...
  ADD CONSTRAINT `coursework_type1` FOREIGN KEY (`coursework_type_ID`) REFERENCES `coursework_type` (`coursework_type_id`);
