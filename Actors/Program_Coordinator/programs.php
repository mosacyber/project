                                        ...
                                        <div class="modal-body">
                                            <div class="popup-form" id="popupForm">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="programName" class="form-label">أسم
                                                                البرنامج</label><br>
                                                            <input type="text" class="form-control" name="programName"
                                                                id="programName" value="<?php echo $Program_Name; ?>"
                                                                readonly>
                                                        </div>
                                                        <div class="mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="subjecName" class="form-label">أسم
                                                                المقرر</label><br>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="NumberHour" class="form-label">عدد
                                                                الساعات</label><br>
                                                            <input type="number" class="form-control" min="0"
                                                                name="NumberHour" id="NumberHour" value="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <br /> <br />
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="mb-3 center">
                                                            ...
                                                            <input type="number" class="form-control" min="1"
                                                                numaxlength="1" id="Hour" name="Hour" value="" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3 text-end">
                                                            <label for="eventName" class="form-label">المقرر : <input
                                                                    type="text" id="Dsubject"
                                                                    style="border: none;"></label>
                                                            <label for="eventName" class="form-label">الساعات : <input
                                                                    type="text" id="Dhour"
                                                                    style="border: none;"></label>
                                                            <input type="text" id="code"
                                                                style="border: none; display: none;">
                                                            <label for="Message" class="form-label">هل ترغب في حذف هذا
                                                                المقرر؟</label>
                                                        </div>
                                                        <br /> <br />
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class=" text-end">
                                                            ...
                                                            <label for="eventName" class="form-label">تمت العملية
                                                                بنجاح</label>
                                                        </div>
                                                        <br /> <br />
                                                        <div class="d-flex justify-content-start">
