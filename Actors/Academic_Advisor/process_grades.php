              ...
              <div class="mb-3">
                  ...
                  <select class="form-select" id="Name" name="Student">
                    ...
                    <?php foreach ($student as $students): ?>
                             <option value="<?php echo $students['student_id']; ?>"><?php echo $students['student_name']; ?></option>
                    <?php endforeach; ?>
                  </select>
                ...
                <div class="input-group mt-3">
                  ...
                  <input type="text" class="form-control" name="subject" id="subject" readonly value="<?php echo $subjectCode ?>"/>
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select class="form-select" id="work">
                      ...
                      <?php foreach ($type as $types): ?>
                          <option value="<?php echo $types['coursework_id']; ?>"><?php echo $types['coursework_type_name']; ?> <span id="gr"><?php echo $types['coursework_grade']; ?></span></option>
                      <?php endforeach; ?>
                  </select>
                ...
                <div class="popup-form" id="popupForm">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <label for="eventName" class="form-label">النشاط : <input type="text" id="Dsubject" style="border: none;"></label>
                            <label for="eventName" class="form-label">الطالب : <input type="text" id="Dname" style="border: none;"></label>
