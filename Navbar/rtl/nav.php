    ...
    <div class='tab-content' id='setting-content'>
      ...
      <div class='tab-pane fade' id='chats-section' role='tabpanel' aria-labelledby='chats-section'>
        ...
        <ul class='chat-list'>
          ...
          <li class='list'>
            <div class='profile'><img src='../../assets/img/profile-img.png' alt='image'><span class='online'></span></div>
            <div class='info'>
...
/*********************************/
      ...
      <li class="nav-item">
      <a class="nav-link" href="'.$config['app_url'].'Actors/student/course/index.php">
        <i class="fa fa-home menu-icon"></i>
        <span class="menu-title">
        المقررات المسجلة
        </span>
    ...
    <li class="nav-item">
    <a class="nav-link" href="'.$config['app_url'].'Actors/student/course/index2.php">
      <i class="fa fa-home menu-icon"></i>
      <span class="menu-title">
السجل الاكاديمي
      </span>
