              ...
              <div class="menu-bar">
                <ul class="menu-items">
                  <li class="compose mb-3">
                    <h1 class="btn btn-primary btn-block">تحديث</ا>
                  </li>
                  <li class="active"><a href="#"><i class="fa fa-envelope-open"></i> البريد الوارد </a><span
                ...
                <div class="attachments-sections">
                  <form method="POST">
                    <div class="input-group" style="margin-buttun: 0;">
                      <input type="text" class="form-control" name="message_contents"
