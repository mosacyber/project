    ...
    <div class="tab-content pt-2">
      <div class="tab-pane fade show active profile-overview" id="profile-overview">
        ...
        <div class="row mb-3">
          ...
          <input type="number" class="form-control" name="account_id" value="<?php echo $account_id; ?>" >
        </div>
        <div class="row mb-3">
...
if(isset($_POST['update'])) {
    ...
    $account_id2 = $_POST['account_id'];
    // استخدم استعلام SQL لتحديث البيانات
    $update_sql = "UPDATE accounts SET 	Account_ID='$account_id2', First_Name='$first_name', Last_Name='$last_name', Email='$email', Mobile='$mobile', Position='$position' WHERE Account_ID='$account_id'";
